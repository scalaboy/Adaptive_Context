...
class SCAR(nn.Module):
    def __init__(self, load_weights=False):
        ...
        self.own_reslayer_3 = make_res_layer(Bottleneck, 256, 2, stride=1)
        self.own_reslayer_3.load_state_dict(res.layer3.state_dict(),strict=False)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv4 = nn.Conv2d(planes * self.expansion, planes, kernel_size=1, bias=False)
        self.bn4 = nn.BatchNorm2d(planes)
        self.conv5 = nn.Conv2d(planes, planes, kernel_size=3, stride=stride,
                               padding=1, bias=False)
        self.bn5 = nn.BatchNorm2d(planes)
        self.conv6 = nn.Conv2d(planes, planes * self.expansion, kernel_size=1, bias=False)
        self.bn6 = nn.BatchNorm2d(planes * self.expansion)
