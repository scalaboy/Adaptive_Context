...
class SCAR(nn.Module):
    def __init__(self, load_weights=False):
        ...
        model_dir = '/deeplp/mainspace/git_dir/Context-Aware-Crowd-Counting/checkpoint_my/best_model/resnet18/model_best.pth.tar'
        checkpoint = torch.load(model_dir)

        new_weight_dict = re_name_weight(checkpoint['state_dict'])
        self.frontend = Res50()
        #self.frontend.load_state_dict(new_weight_dict,strict=False)
        self.frontend.load_state_dict(checkpoint['state_dict'],strict=False)
