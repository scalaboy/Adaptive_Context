...
#__C.NET = 'CANNet' # net selection: MCNN, AlexNet, VGG, VGG_DECODER, Res50, CSRNet, SANet

__C.NET = 'SCAR' # net selection: MCNN, AlexNet, VGG, VGG_DECODER, Res50, CSRNet, SANet
...
__C.RESUME = False # contine training
__C.RESUME_PATH = './exp/03-18_17-03_NWPU_SCAR_1e-05/latest_state.pth'
